...
{
    [TestClass]
    public class UpdateCurrentToolTest
    {
        ...
        IRequestHandler<UpdateCurrentToolAsyncCommand, CurrentToolDto> handler;
        ...
        public void Init()
        {
            ...
            handler = new UpdateCurrentToolAsyncCommandHandler(implementationMock.Object, discoveryServiceMock.Object);
        }
        ...
        public async Task HandleSuccessfulTest()
        {
            ...
            UpdateCurrentToolAsyncCommand request = new(currentToolDto);

            discoveryServiceMock.Setup(x => x.FirstOrDefautlModelBy(It.IsAny<Expression<Func<Discovery, bool>>>())).ReturnsAsync(discoveryDto);
            implementationMock.Setup(x => x.UpdateModel(It.IsAny<CurrentToolDto>())).ReturnsAsync(currentToolDto);
